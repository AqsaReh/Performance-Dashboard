  ...
  (
    ...
    >
      ...
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none z-10 origin-right  h-4 w-4 rounded-full bg-background  shadow-lg ring-0 transition-all  flex items-center justify-center   ltr:data-[state=checked]:ml-4 rtl:data-[state=checked]:mr-5 rtl:data-[state=unchecked]:mr-0.5 ",
          thumbClass,
          {
