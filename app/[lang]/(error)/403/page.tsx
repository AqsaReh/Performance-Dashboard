      ...
      <div className='w-full flex flex-col items-center'>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="mt-3 text-default-600 text-sm md:text-base">
            You don't have permission to access this resource. <br /> Please contact your administrator if you believe this is an error.
          </div>
          <Button asChild className="mt-9 md:min-w-[300px]" size="lg">
            <Link href="/capex/dashboard">Go to Dashboard</Link>
          </Button>
        </div>
      </div>
    </div>
